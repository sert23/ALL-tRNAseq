...
# colors
# mim-tRNAseq   DM-tRNA-seq ALL-tRNAseq
# DM-tRNA-seq a346ff, mim-tRNAseq 26b9ff, ALL-tRNAseq ff2d2d

color_dict = { "mim-tRNAseq" : "#26b9ff",
                "DM-tRNA-seq" : "#a346ff",
                "ALL-tRNAseq" : "#ff2d2d",
}

for sample,values in values_dict.items():
    ax.plot(angles, values, linewidth=1, linestyle='solid', label=sample, color=color_dict.get(sample))
