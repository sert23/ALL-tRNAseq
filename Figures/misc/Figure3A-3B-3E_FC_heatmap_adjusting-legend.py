...
rainBow = cm.get_cmap('bwr_r', 200)
no_purple_cmap = ListedColormap(rainBow(np.linspace(0, 1, 256)))
...
if len(sys.argv)>1:
    ...
    # file_path = "/graph_scripts/FC_heatmap/heatmap_HB-GBM.txt"
    file_path = "/graph_scripts/FC_heatmap/hESC_anticodon_FL.txt"
...
# plt.savefig("/graph_scripts/FC_heatmap/heatmap_HB-GBM.png")
